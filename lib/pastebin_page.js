...
class PastebinPage extends Page {
    ...
    async syntaxHighlighting () {
        await this.driver.wait(until.elementLocated(By.xpath('(//a[@class="btn -small h_800"])[1]')));
        return await this.driver.findElement(By.xpath('(//a[@class="btn -small h_800"])[1]')).getText();
    } 
    async getPageTitle () {        
